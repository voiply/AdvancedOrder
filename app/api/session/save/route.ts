    ...
    if (existing) {
      ...
      await db
        ...
        .bind(
          ...
          selectedPlan || null,
          selectedBundle || null,
          selectedPhones ? JSON.stringify(selectedPhones) : null,
          numUsers || 1,
          callMethod || null,
          numLocations || null,
          highCallVolume || null,
          needCallRecording || null,
          ownDevice ? 1 : 0,
          onlineFax ? 1 : 0,
      ...
      await db
        .prepare(`
          INSERT INTO sessions (
            ...
            selected_plan, selected_bundle, selected_phones, num_users,
            call_method, num_locations, high_call_volume, need_call_recording,
            own_device,
